...
const EditedPage = (props)=> {
  ...
  const {event :{dateTime, time, type, name, timePass, description, descriptionUrl, place, comment, picture, video, map, showComment}, eventId, onUpdateEvent, organizer} = props;
